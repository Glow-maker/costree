...
| 成本业务库 | 旧库升级脚本 | 空库脚本 |
|---|---|---|
| PostgreSQL 14+ | 依次执行 `12-upgrade-existing-to-20260817-access-scope.sql`、`13-upgrade-existing-to-20260818-domain-scope.sql` | `<backend-root>/sql/postgresql/costree-cost.sql` |
| PostgreSQL 9.2 / GaussDB 8.2.1 | 依次执行 `12-upgrade-existing-to-20260817-access-scope.sql`、`13-upgrade-existing-to-20260818-domain-scope.sql` | `<backend-root>/sql/postgresql92/costree-cost.sql` |
| MySQL 8 | `costree-cost-20260817-access-scope.sql`、`costree-cost-20260818-domain-scope.sql` | `<backend-root>/sql/mysql/costree-cost.sql` |
...
2. 备份成本业务库。
3. 旧库按对应方言执行升级链，确保包含 `12-upgrade-existing-to-20260817-access-scope.sql` 和 `13-upgrade-existing-to-20260818-domain-scope.sql`。
4. 执行 `20-verify.sql`。
5. 确认存在 `cost_user_domain_scope`、`cost_user_project_scope`、`cost_user_unit_scope`。
