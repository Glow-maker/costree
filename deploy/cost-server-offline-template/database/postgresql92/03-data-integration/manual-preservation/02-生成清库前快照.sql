...
DELETE FROM cost_manual_snapshot.warning_state WHERE batch_code = :'manual_batch' AND tenant_id = :'manual_tenant'::int8;
...
INSERT INTO cost_manual_snapshot.warning_state
...
UNION ALL SELECT :'manual_batch', :'manual_tenant'::int8, 'warning_state', count(*) FROM cost_manual_snapshot.warning_state WHERE batch_code = :'manual_batch' AND tenant_id = :'manual_tenant'::int8;
